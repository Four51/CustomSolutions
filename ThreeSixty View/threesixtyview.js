angular.module('OrderCloud-ThreeSixtyField', []);

angular.module('OrderCloud-ThreeSixtyField')
    .directive('threesixtyfield', ThreeSixtyFieldDirective)
    .controller('threesixtyfieldCtrl', ThreeSixtyFieldController)
;

function ThreeSixtyFieldDirective() {
    return {
        scope: {
            p : '='
        },
        ...
        '</div></div></div></div>',
        controller: 'threesixtyfieldCtrl'
    };
}

ThreeSixtyFieldController.$inject = ['$scope']
function ThreeSixtyFieldController($scope) {
