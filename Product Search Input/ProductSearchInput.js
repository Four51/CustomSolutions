...
angular.module('OrderCloud-ProductSearchInput')
	...
	.directive('productsearchinput', function() {
		var obj = {
			restrict: 'E',
	...
	.directive('productsearchinputnav', function() {
		var obj = {
			restrict: 'E',
			templateUrl: 'productSearchNav.html',
			controller: 'ProductSearchInputCtrl'
		};
		return obj;
	})

	.controller('ProductSearchInputCtrl', ['$scope','$location', function($scope,$location) {
	...
	.run(['$templateCache', function($templateCache) {
		$templateCache.put('productSearch.html',
		...
		$templateCache.put('productSearchNav.html',
