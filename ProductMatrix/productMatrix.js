...
angular.module('OrderCloud-ProductMatrix')
    ...
    .controller('productmatrixcontroller', ProductMatrixCtrl)
;

function definesVariantFilter() {
...
ProductMatrixFactory.$inject = ['$resource', '$451', 'Variant'];
function ProductMatrixFactory($resource, $451, Variant) {
