...
;
    ...
    function ProductMatrix($resource, $451, Variant) {
        var service = {
            ...
            getMinMaxTotalQty: getMinMaxTotalQty
        };
        return service;
        ...
        function getMinMaxTotalQty(product) {
        ...
        function build(product, order, lineItemEdit, success) {
            var specCombos = {};
        ...
        function validateQty(matrix, product, success) {
            var qtyError = "";
        ...
        function addToOrder(matrix, product, extraSpecs, success) {
            var lineItems = [];
            angular.forEach(matrix, function(group) {
